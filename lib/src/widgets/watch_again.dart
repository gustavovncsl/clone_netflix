...
import 'package:clone_netflix/src/screens/info_page_watch_again.dart';
...
class watch_again extends StatefulWidget {
  const watch_again({Key? key}) : super(key: key);

  @override
  _watch_againState createState() => _watch_againState();
}

class _watch_againState extends State<watch_again> {
  var future_poster;
  ...
  void initState() {
    super.initState();
    future_poster = getFetchedMoviesWatchAgain();
  }
