...
import 'package:clone_netflix/src/api_request/api_movies_watch_again.dart';
...
class info_page_watch_again extends StatefulWidget {
  int index;

  info_page_watch_again({Key? key, required this.index}) : super(key: key);
  @override
  _info_page_watch_againState createState() => _info_page_watch_againState();
}

class _info_page_watch_againState extends State<info_page_watch_again> {
  var detail_movie;
  ...
  void initState() {
    super.initState();
    detail_movie = getFetchedMoviesWatchAgain();
  }
