...
class info_page_detail extends StatefulWidget {
  int index;

  info_page_detail({Key? key, required this.index}) : super(key: key);
  @override
  _info_page_detailState createState() => _info_page_detailState();
}

class _info_page_detailState extends State<info_page_detail> {
  var detail_movie;
